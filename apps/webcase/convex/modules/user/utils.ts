import { WebhookEvent } from "@clerk/tanstack-react-start/webhooks";
import { Webhook } from "svix";

export async function validateClerkUserWebhookRequest(req: Request): Promise<WebhookEvent | null> {
